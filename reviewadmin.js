     ...
     document.addEventListener("DOMContentLoaded", function() {
            ...
            ipLinks.forEach(function(ipLink) {
                ipLink.addEventListener('click', function(event) {
                    ...
                    // Get the text content of the clicked link (e.g., "IP 1")
                    const ipText = this.textContent;

                    // Display detailed information about the clicked IP
                    const ipDetails = document.getElementById('ip-details');
                    ipDetails.style.display = 'block';
                    ipDetails.innerHTML = '<h3>' + ipText + ' Details</h3>' +
                        '<p>Detailed information about ' + ipText + ' goes here.</p>';
                    }
